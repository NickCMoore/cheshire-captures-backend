    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='images/default_photo.jpg', upload_to='images/')),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'constraints': [models.UniqueConstraint(fields=('user', 'photo', 'content'), name='unique_user_photo_content')],
            },
        ),
        migrations.CreateModel(
            name='PhotoRating',
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('user', 'photo'), name='unique_user_photo_rating')],
            },
        ),
    ]
